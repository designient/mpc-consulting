...
},
{
  ...
  a: 'Yes. Our Oracle ERP practice supports global enterprises with complex multi-entity, multi-currency, multi-GAAP requirements across India, UAE, Australia, and the UK.'
}];
