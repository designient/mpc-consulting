...
const SERVICES_LINKS = [
  ...
  { label: 'Application Development', to: SOLUTION_APP_DEV },
  { label: 'Database Migration', to: SOLUTION_DB_MIGRATION },
  { label: 'Cloud Management', to: SOLUTION_CLOUD_MANAGEMENT },
  { label: 'CX & Analytics', to: SERVICE_CX_ANALYTICS },
  { label: 'Power BI', to: SOLUTION_POWER_BI },
  { label: 'Salesforce', to: SOLUTION_SALESFORCE },
  { label: 'ServiceNow', to: SOLUTION_SERVICENOW },
  { label: 'Security & Zero Trust', to: SERVICE_SECURITY },
  { label: 'Cybersecurity & Zero Trust Strategy', to: SOLUTION_ZERO_TRUST_STRATEGY },
  { label: 'Application & Cloud Security', to: SOLUTION_APP_CLOUD_SECURITY },
  { label: 'Infrastructure & Managed Operations', to: SOLUTION_INFRA_MANAGED_OPS },
  { label: 'Treasury Management', to: SERVICE_TREASURY },
  { label: 'IBS Fintech', to: SOLUTION_IBS_FINTECH },
  { label: 'All Aspects of Treasury Management', to: SOLUTION_TREASURY_OPERATIONS },
  { label: 'HCM', to: SOLUTION_HCM },
  { label: 'ERP (Oracle Cloud)', to: SOLUTION_ERP },
  { label: 'Oracle SCM', to: SOLUTION_SCM },
  { label: 'Oracle EPM', to: SOLUTION_EPM },
  { label: 'Oracle Unifier', to: SOLUTION_UNIFIER },
  { label: 'Tech', to: SOLUTION_TECH },
  { label: 'Java Technologies', to: SOLUTION_JAVA },
  { label: 'DevOps Services', to: SOLUTION_DEVOPS },
  { label: 'Business Process Consulting', to: SOLUTION_BPC },
  { label: 'HCaaS', to: SOLUTION_HCAAS },
  { label: 'AaaS', to: SOLUTION_AAAS },
];
